...
export default function SettingsTheme() {
  ...
  return(
    <div className={styles.themeWrapper}>
      <div className={`${styles.themeName} f-nunito`}>{themes.get(themeHandler()).name}</div>
      ...
      <PopMenuFrame showPopup={showPopup} setShowPopup={setShowPopup}>
        {
          [...themes].map(theme => (
            <div key={theme[0]} className={`${styles.themeWrapper} ${styles.themeWrapperModsForFrame}`} onClick={()=>themeHandler(theme[0])}>
