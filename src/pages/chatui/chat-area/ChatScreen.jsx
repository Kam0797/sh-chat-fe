  ...
  return(
    <div className='chat-screen-wrapper'>
      <div className='chat-screen-top-bar'>
        <div className='profile-pic'>{chatData.name.slice(0,2)}</div>
